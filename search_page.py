...
class ThreadSearch(ISearchParam, tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        count = 1
        for key, value in THREAD_RB_TYPE[LANG]:
            tk.Radiobutton(self, text=value, variable=thread_variant, value=key).grid(row=count, column=1)
            count += 1
